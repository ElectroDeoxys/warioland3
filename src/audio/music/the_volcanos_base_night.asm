...
Music_TheVolcanosBaseNight: ; 34d69 (d:4d69)
	...
	dw Music_TheVolcanosBaseNight_Ch3

; unused?
	dw Music_TheVolcanosBaseNight_Ch1.loop
	dw Music_TheVolcanosBaseNight_Ch2.loop
	dw Music_TheVolcanosBaseNight_Ch3.loop

	dw Music_TheVolcanosBaseNight_Ch1.end
	dw Music_TheVolcanosBaseNight_Ch2.end
	dw Music_TheVolcanosBaseNight_Ch3.end
