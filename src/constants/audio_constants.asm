...
DEF CHANNEL_STRUCT_LENGTH EQU _RS
	...
	const_def
	const CHANNELFLAGS_0_F      ; 0
	const CHANNELFLAGS_1_F      ; 1
	const CHANNELFLAGS_2_F      ; 2
	const CHANNELFLAGS_3_F      ; 3
	const CHANNELFLAGS_4_F      ; 4
	const CHANNELFLAGS_5_F      ; 5
	const CHANNELFLAGS_6_F      ; 6
	const CHANNELFLAGS_ACTIVE_F ; 7

DEF CHANNELFLAGS_0      EQU (1 << CHANNELFLAGS_0_F)
DEF CHANNELFLAGS_1      EQU (1 << CHANNELFLAGS_1_F)
DEF CHANNELFLAGS_2      EQU (1 << CHANNELFLAGS_2_F)
DEF CHANNELFLAGS_3      EQU (1 << CHANNELFLAGS_3_F)
DEF CHANNELFLAGS_4      EQU (1 << CHANNELFLAGS_4_F)
DEF CHANNELFLAGS_5      EQU (1 << CHANNELFLAGS_5_F)
DEF CHANNELFLAGS_6      EQU (1 << CHANNELFLAGS_6_F)
DEF CHANNELFLAGS_ACTIVE EQU (1 << CHANNELFLAGS_ACTIVE_F)
