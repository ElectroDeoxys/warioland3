...
DEF MBC5RomBank     EQU $2100
DEF MBC5HighRomBank EQU $3100
DEF MBC5SRamBank    EQU $4100
...
DEF TILE_BANK EQU 1 << OAM_TILE_BANK
DEF OBP_NUM   EQU 1 << OAM_OBP_NUM
DEF X_FLIP    EQU 1 << OAM_X_FLIP
DEF Y_FLIP    EQU 1 << OAM_Y_FLIP
DEF PRIORITY  EQU 1 << OAM_PRIORITY
