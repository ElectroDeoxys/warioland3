...
; constants for wRoomTransitionParam
	...
	const ROOMTRANSITIONF_1_F ; 5
	const ROOMTRANSITIONF_2_F ; 6
	const ROOMTRANSITIONF_3_F ; 7

DEF ROOMTRANSITIONF_0 EQU (1 << ROOMTRANSITIONF_0_F)
DEF ROOMTRANSITIONF_1 EQU (1 << ROOMTRANSITIONF_1_F)
DEF ROOMTRANSITIONF_2 EQU (1 << ROOMTRANSITIONF_2_F)
DEF ROOMTRANSITIONF_3 EQU (1 << ROOMTRANSITIONF_3_F)

DEF ROOMTRANSITION_MASK EQU $0f
DEF ROOMTRANSITION_FLAGS_MASK EQU ROOMTRANSITIONF_0 | ROOMTRANSITIONF_1 | ROOMTRANSITIONF_2 | ROOMTRANSITIONF_3
