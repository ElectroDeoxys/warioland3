...
; constants for wRoomTransitionParam
	...
	const ROOMTRANSITION_3    ; 3
	const ROOMTRANSITION_4    ; 4
	const ROOMTRANSITION_5    ; 5
	const ROOMTRANSITION_6    ; 6
	const ROOMTRANSITION_7    ; 7
	const ROOMTRANSITION_8    ; 8

	const_def 4
	const ROOMTRANSITIONFLAG_0_F ; 4
	const ROOMTRANSITIONFLAG_1_F ; 5
	const ROOMTRANSITIONFLAG_2_F ; 6
	const ROOMTRANSITIONFLAG_3_F ; 7

DEF ROOMTRANSITIONFLAG_0 EQU (1 << ROOMTRANSITIONFLAG_0_F)
DEF ROOMTRANSITIONFLAG_1 EQU (1 << ROOMTRANSITIONFLAG_1_F)
DEF ROOMTRANSITIONFLAG_2 EQU (1 << ROOMTRANSITIONFLAG_2_F)
DEF ROOMTRANSITIONFLAG_3 EQU (1 << ROOMTRANSITIONFLAG_3_F)
