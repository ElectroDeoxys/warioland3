...
; an ID constant is defined for each object data
; this is not unique for each object,
; but is used to identify object type through OBJ_ID
; high nybble must correspond to OAM/Update func bank
; (see src/data/object_data.asm)
DEF DUMMY_OBJECT            EQU (0 << 4) | $0 | $80 ; $00
DEF GREY_CHEST              EQU (3 << 4) | $1 ; $31
DEF RED_CHEST               EQU (3 << 4) | $1 ; $31
DEF GREEN_CHEST             EQU (3 << 4) | $1 ; $31
DEF BLUE_CHEST              EQU (3 << 4) | $1 ; $31
DEF GREY_KEY_O              EQU (3 << 4) | $2 ; $32
DEF RED_KEY_O               EQU (3 << 4) | $2 ; $32
DEF GREEN_KEY_O             EQU (3 << 4) | $2 ; $32
DEF BLUE_KEY_O              EQU (3 << 4) | $2 ; $32
DEF MUSICAL_COIN            EQU (3 << 4) | $3 ; $33
DEF SPEARHEAD               EQU (0 << 4) | $0 ; $00
DEF FUTAMOGU                EQU (0 << 4) | $1 ; $01
DEF WEBBER                  EQU (0 << 4) | $2 ; $02
DEF TORCH                   EQU (0 << 4) | $4 ; $04
DEF TORCH_NO_EMBERS         EQU (0 << 4) | $6 ; $06
DEF FLAME_BLOCK_TORCH       EQU (0 << 4) | $7 ; $07
DEF FLAME_BLOCK             EQU (2 << 4) | $b ; $2b
DEF STOVE                   EQU (2 << 4) | $c ; $2c
DEF UNUSED_FLOWER           EQU (0 << 4) | $6 ; $06
DEF COUNT_RICHTERTOFFEN     EQU (0 << 4) | $7 ; $07
DEF HEBARII                 EQU (2 << 4) | $0 ; $20
DEF PARA_GOOM               EQU (0 << 4) | $9 ; $09
DEF DOUGHNUTEER             EQU (0 << 4) | $a ; $0a
DEF OMODONMEKA              EQU (0 << 4) | $b ; $0b
DEF OMODONMEKA_WITH_OMODON1 EQU (0 << 4) | $c ; $0c
DEF OMODONMEKA_WITH_OMODON2 EQU (0 << 4) | $c ; $0c
DEF KUSHIMUSHI_VERTICAL     EQU (0 << 4) | $c ; $0c
DEF KUSHIMUSHI_HORIZONTAL   EQU (0 << 4) | $d ; $0d
DEF MIZUUO                  EQU (2 << 4) | $4 ; $24
DEF BIG_LEAF_SPAWNER        EQU (0 << 4) | $b ; $0b
DEF SMALL_LEAF              EQU (0 << 4) | $8 ; $08
DEF SILKY                   EQU (0 << 4) | $c ; $0c
DEF ORANGE_BIRD             EQU (0 << 4) | $f ; $0f
DEF BLUE_BIRD               EQU (0 << 4) | $d ; $0d
DEF SNAKE                   EQU (2 << 4) | $d ; $2d
DEF APPLEBY                 EQU (1 << 4) | $d ; $1d
DEF BARREL1                 EQU (0 << 4) | $4 ; $04
DEF BARREL2                 EQU (0 << 4) | $5 ; $05
DEF ROCK                    EQU (2 << 4) | $3 ; $23
DEF RED_PRINCE_FROGGY       EQU (1 << 4) | $1 ; $11
DEF GREY_PRINCE_FROGGY      EQU (1 << 4) | $1 ; $11
DEF HAMMER_BOT              EQU (1 << 4) | $2 ; $12
DEF TERUTERU                EQU (1 << 4) | $0 ; $10
DEF MAD_SCIENSTEIN          EQU (1 << 4) | $5 ; $15
DEF SEEING_EYE_DOOR         EQU (1 << 4) | $3 ; $13
DEF PNEUMO                  EQU (1 << 4) | $6 ; $16
DEF ELECTRIC_LAMP           EQU (1 << 4) | $7 ; $17
DEF ZOMBIE                  EQU (1 << 4) | $9 ; $19
DEF FIRE_BOT                EQU (1 << 4) | $c ; $1c
DEF SPEAR_BOT               EQU (1 << 4) | $b ; $1b
DEF BEAM_BOT                EQU (1 << 4) | $4 ; $14
DEF SUN                     EQU (1 << 4) | $a ; $1a
DEF MOON                    EQU (1 << 4) | $a ; $1a
DEF KOBATTO                 EQU (1 << 4) | $0 ; $10
DEF HAND                    EQU (1 << 4) | $6 ; $16
DEF BUBBLE_HOLE             EQU (1 << 4) | $e ; $1e
DEF BRRR_BEAR               EQU (2 << 4) | $0 ; $20
DEF CART_LEFT               EQU (2 << 4) | $2 ; $22
DEF CART_RIGHT              EQU (2 << 4) | $3 ; $23
DEF CART_VARIABLE_LEFT      EQU (2 << 4) | $2 ; $22
DEF CART_VARIABLE_RIGHT     EQU (2 << 4) | $3 ; $23
DEF ROBO_MOUSE              EQU (2 << 4) | $6 ; $26
DEF TOGEBA                  EQU (2 << 4) | $7 ; $27
DEF HARIDAMA                EQU (2 << 4) | $8 ; $28
DEF OWL                     EQU (2 << 4) | $9 ; $29
DEF ZIP_LINE1               EQU (2 << 4) | $4 ; $24
DEF ZIP_LINE2               EQU (2 << 4) | $5 ; $25
DEF ZIP_LINE3               EQU (2 << 4) | $6 ; $26
DEF ZIP_LINE4               EQU (2 << 4) | $7 ; $27
DEF ZIP_LINE5               EQU (2 << 4) | $8 ; $28
DEF ANONSTER                EQU (4 << 4) | $0 ; $40
DEF SILK_PLATFORMS          EQU (4 << 4) | $2 ; $42
DEF FALLING_SNOW_SPAWNER    EQU (2 << 4) | $9 ; $29
DEF DOLL_BOY                EQU (4 << 4) | $8 ; $48
DEF HAMMER_PLATFORM_SPAWNER EQU (4 << 4) | $5 ; $45
DEF DOLL_BOY_BARREL1        EQU (4 << 4) | $1 ; $41
DEF DOLL_BOY_BARREL2        EQU (4 << 4) | $2 ; $42
DEF DOLL_BOY_BARREL3        EQU (4 << 4) | $4 ; $44
DEF WORMWOULD               EQU (5 << 4) | $7 ; $57
DEF PALM_TREE_SPAWNER       EQU (5 << 4) | $9 ; $59
DEF PILLAR_PLATFORM1        EQU (2 << 4) | $0 ; $20
DEF PILLAR_PLATFORM2        EQU (2 << 4) | $0 ; $20
DEF PILLAR_PLATFORM3        EQU (2 << 4) | $0 ; $20
DEF WATER_DROP              EQU (2 << 4) | $1 ; $21
DEF YELLOW_BELLY_BODY       EQU (4 << 4) | $b ; $4b
DEF YELLOW_BELLY_PLATFORM   EQU (4 << 4) | $f ; $4f
DEF NOBIIRU_LEFT            EQU (0 << 4) | $a ; $0a
DEF NOBIIRU_RIGHT           EQU (0 << 4) | $b ; $0b
DEF CLEAR_GATE1             EQU (0 << 4) | $e ; $0e
DEF CLEAR_GATE2             EQU (0 << 4) | $e ; $0e
DEF CLEAR_GATE3             EQU (0 << 4) | $e ; $0e
DEF PESCE                   EQU (4 << 4) | $5 ; $45
DEF DRAGONFLY_SPAWNER       EQU (4 << 4) | $6 ; $46
DEF FLY_SPAWNER             EQU (4 << 4) | $7 ; $47
DEF STRONG_WATER_CURRENT    EQU (4 << 4) | $0 ; $40
DEF DRAGONFLY2              EQU (4 << 4) | $1 ; $41
DEF TADPOLE_SPAWNER         EQU (2 << 4) | $2 ; $22
DEF WATER_SPARK             EQU (2 << 4) | $d ; $2d
DEF SMALL_OCTOHON           EQU (2 << 4) | $0 ; $20
DEF BIG_OCTOHON             EQU (2 << 4) | $1 ; $21
DEF SPARK_HORIZONTAL        EQU (2 << 4) | $2 ; $22
DEF SPARK_VERTICAL          EQU (2 << 4) | $0 ; $20
DEF SCOWLER                 EQU (5 << 4) | $0 ; $50
DEF FLOATING_RING_SPAWNER   EQU (5 << 4) | $4 ; $54
DEF FIRE                    EQU (2 << 4) | $4 ; $24
DEF JAMANO                  EQU (5 << 4) | $6 ; $56
DEF SKULL_SPAWNER           EQU (5 << 4) | $7 ; $57
DEF HAT_PLATFORM            EQU (5 << 4) | $9 ; $59
DEF MUDDEE                  EQU (5 << 4) | $a ; $5a
DEF TURTLE1                 EQU (5 << 4) | $b ; $5b
DEF TURTLE2                 EQU (5 << 4) | $c ; $5c
DEF WOLFENBOSS              EQU (5 << 4) | $d ; $5d
DEF WOLFENBOSS_PLATFORM     EQU (5 << 4) | $a ; $5a
DEF SHOOT                   EQU (5 << 4) | $0 ; $50
DEF GK_TORTOISE             EQU (5 << 4) | $1 ; $51
DEF SHOOT_GOAL_COUNTER      EQU (5 << 4) | $a ; $5a
DEF WARIO_GOAL_COUNTER      EQU (5 << 4) | $b ; $5b
DEF GK_TORTOISE_PLATFORM    EQU (5 << 4) | $5 ; $55
DEF WALL_CRACK_CLOSED       EQU (3 << 4) | $6 ; $36
DEF WALL_CRACK_OPEN         EQU (3 << 4) | $6 ; $36
DEF HIDDEN_FIGURE           EQU (3 << 4) | $a ; $3a

; object IDs for objects spawned in
; (see src/data/object_params.asm)
DEF HEBARII_PROJECTILE             EQU (2 << 4) | $1 ; $21
DEF WEBBER_PROJECTILE              EQU (0 << 4) | $3 ; $03
DEF UNUSED_FLOWER_PROJECTILE_LEFT  EQU (0 << 4) | $5 ; $05
DEF UNUSED_FLOWER_PROJECTILE_RIGHT EQU (0 << 4) | $5 ; $05
DEF BIG_LEAF1                      EQU (0 << 4) | $8 ; $08
DEF BIG_LEAF2                      EQU (0 << 4) | $8 ; $08
DEF BIG_LEAF3                      EQU (0 << 4) | $8 ; $08
DEF DOUGHNUT_LEFT                  EQU (0 << 4) | $b ; $0b
DEF DOUGHNUT_RIGHT                 EQU (0 << 4) | $b ; $0b
DEF DOUGHNUT_UP_LEFT               EQU (0 << 4) | $b ; $0b
DEF DOUGHNUT_UP_RIGHT              EQU (0 << 4) | $b ; $0b
DEF INVISIBILITY_POTION_LEFT       EQU (1 << 4) | $6 ; $16
DEF INVISIBILITY_POTION_RIGHT      EQU (1 << 4) | $6 ; $16
DEF INVISIBILITY_POTION_DROP_LEFT  EQU (1 << 4) | $6 ; $16
DEF INVISIBILITY_POTION_DROP_RIGHT EQU (1 << 4) | $6 ; $16
DEF ZOMBIE_HEAD_LEFT               EQU (1 << 4) | $a ; $1a
DEF ZOMBIE_HEAD_RIGHT              EQU (1 << 4) | $a ; $1a
DEF STARS_LEFT                     EQU (3 << 4) | $0 ; $30
DEF STARS_RIGHT                    EQU (3 << 4) | $0 ; $30
DEF BEAM_LEFT                      EQU (1 << 4) | $1 ; $11
DEF BEAM_RIGHT                     EQU (1 << 4) | $1 ; $11
DEF APPLE_LEFT                     EQU (1 << 4) | $1 ; $11
DEF APPLE_RIGHT                    EQU (1 << 4) | $1 ; $11
DEF SUN_FLAME_LEFT                 EQU (1 << 4) | $b ; $1b
DEF SUN_FLAME_RIGHT                EQU (1 << 4) | $b ; $1b
DEF MOON_STAR_LEFT                 EQU (1 << 4) | $b ; $1b
DEF MOON_STAR_RIGHT                EQU (1 << 4) | $b ; $1b
DEF BIRD_STARS1                    EQU (3 << 4) | $0 ; $30
DEF BIRD_STARS2                    EQU (3 << 4) | $0 ; $30
DEF SNOWFLAKE_LEFT                 EQU (2 << 4) | $1 ; $21
DEF SNOWFLAKE_RIGHT                EQU (2 << 4) | $1 ; $21
DEF MIZZOU_PROJECTILE_LEFT         EQU (2 << 4) | $5 ; $25
DEF MIZZOU_PROJECTILE_RIGHT        EQU (2 << 4) | $5 ; $25
DEF GREY_TREASURE_O                EQU (3 << 4) | $3 ; $33
DEF RED_TREASURE_O                 EQU (3 << 4) | $3 ; $33
DEF GREEN_TREASURE_O               EQU (3 << 4) | $3 ; $33
DEF BLUE_TREASURE_O                EQU (3 << 4) | $3 ; $33
DEF ANONSTER_SILK1_LEFT            EQU (4 << 4) | $1 ; $41
DEF ANONSTER_SILK1_RIGHT           EQU (4 << 4) | $1 ; $41
DEF ANONSTER_SILK2_LEFT            EQU (4 << 4) | $1 ; $41
DEF ANONSTER_SILK2_RIGHT           EQU (4 << 4) | $1 ; $41
DEF ANONSTER_SILK3_LEFT            EQU (4 << 4) | $1 ; $41
DEF ANONSTER_SILK3_RIGHT           EQU (4 << 4) | $1 ; $41
DEF ANONSTER_WAVE_LEFT             EQU (4 << 4) | $1 ; $41
DEF ANONSTER_WAVE_RIGHT            EQU (4 << 4) | $1 ; $41
DEF SILK_PLATFORM1                 EQU (4 << 4) | $3 ; $43
DEF SILK_PLATFORM2                 EQU (4 << 4) | $3 ; $43
DEF SILK_PLATFORM3                 EQU (4 << 4) | $3 ; $43
DEF SNAKE_FIRE_LEFT                EQU (2 << 4) | $e ; $2e
DEF SNAKE_FIRE_RIGHT               EQU (2 << 4) | $e ; $2e
DEF DOLL_BOY_HAMMER                EQU (4 << 4) | $9 ; $49
DEF HAMMER_PLATFORM                EQU (4 << 4) | $6 ; $46
DEF HIGH_ROLLING_ROCK_LEFT         EQU (5 << 4) | $8 ; $58
DEF HIGH_ROLLING_ROCK_RIGHT        EQU (5 << 4) | $8 ; $58
DEF LOW_ROLLING_ROCK_LEFT          EQU (5 << 4) | $8 ; $58
DEF LOW_ROLLING_ROCK_RIGHT         EQU (5 << 4) | $8 ; $58
DEF PALM_TREE_SHORT                EQU (5 << 4) | $a ; $5a
DEF PALM_TREE_MEDIUM               EQU (5 << 4) | $a ; $5a
DEF PALM_TREE_TALL                 EQU (5 << 4) | $a ; $5a
DEF YELLOW_BELLY_ARROW_LEFT        EQU (4 << 4) | $d ; $4d
DEF YELLOW_BELLY_ARROW_RIGHT       EQU (4 << 4) | $d ; $4d
DEF DRAGONFLY1                     EQU (4 << 4) | $8 ; $48
DEF FLY                            EQU (4 << 4) | $9 ; $49
DEF TADPOLE                        EQU (2 << 4) | $f ; $2f
DEF INK_LEFT                       EQU (5 << 4) | $3 ; $53
DEF INK_RIGHT                      EQU (5 << 4) | $3 ; $53
DEF FLOATING_RING                  EQU (5 << 4) | $5 ; $55
DEF SKULL1                         EQU (5 << 4) | $0 ; $50
DEF SKULL2                         EQU (5 << 4) | $1 ; $51
DEF SKULL3                         EQU (5 << 4) | $2 ; $52
DEF SKULL4                         EQU (5 << 4) | $3 ; $53
DEF JAMANO_HAT                     EQU (5 << 4) | $8 ; $58
DEF MAGIC_SPIRAL_LEFT              EQU (5 << 4) | $e ; $5e
DEF MAGIC_SPIRAL_RIGHT             EQU (5 << 4) | $e ; $5e
DEF IGAGURI_LEFT                   EQU (5 << 4) | $f ; $5f
DEF IGAGURI_RIGHT                  EQU (5 << 4) | $f ; $5f
DEF HIDDEN_FIGURE_FACE             EQU (3 << 4) | $b ; $3b
DEF HIDDEN_FIGURE_LEFT_HAND        EQU (3 << 4) | $c ; $3c
DEF HIDDEN_FIGURE_RIGHT_HAND       EQU (3 << 4) | $d ; $3d
DEF OMODON2                        EQU (0 << 4) | $d ; $0d
DEF OMODON1                        EQU (0 << 4) | $d ; $0d
DEF DOLL_BOY_HAMMER_STARS_LEFT     EQU (3 << 4) | $0 ; $30
DEF DOLL_BOY_HAMMER_STARS_RIGHT    EQU (3 << 4) | $0 ; $30
DEF COIN                           EQU (8 << 4) | $1 ; $81
DEF COLOUR_COIN                    EQU (8 << 4) | $1 ; $81
DEF TORCH_EMBER_LEFT1              EQU (0 << 4) | $5 ; $05
DEF TORCH_EMBER_RIGHT1             EQU (0 << 4) | $5 ; $05
DEF TORCH_EMBER_LEFT2              EQU (0 << 4) | $5 ; $05
DEF TORCH_EMBER_RIGHT2             EQU (0 << 4) | $5 ; $05
DEF ELECTRIC_LAMP_SPARK            EQU (1 << 4) | $8 ; $18
DEF BUBBLE                         EQU (1 << 4) | $f ; $1f
DEF FALLING_SNOW                   EQU (2 << 4) | $a ; $2a
DEF STARS_ABOVE                    EQU (3 << 4) | $0 ; $30
DEF YELLOW_BELLY_HEAD              EQU (4 << 4) | $c ; $4c
DEF PUMP                           EQU (4 << 4) | $e ; $4e
DEF CHEESE                         EQU (4 << 4) | $a ; $4a
DEF SCROWLER_TENTACLE_RIGHT        EQU (5 << 4) | $1 ; $51
DEF SCROWLER_TENTACLE_LEFT         EQU (5 << 4) | $2 ; $52
DEF MUDDEE_STINGER1                EQU (3 << 4) | $4 ; $34
DEF MUDDEE_STINGER2                EQU (3 << 4) | $5 ; $35
DEF KURI                           EQU (5 << 4) | $e ; $5e
DEF STARS_CENTRE                   EQU (3 << 4) | $0 ; $30
