...
NUM_COLLECTION_COLS EQU 5
NUM_COLLECTION_ROWS EQU 4
NUM_COLLECTION_CELLS EQU NUM_COLLECTION_COLS * NUM_COLLECTION_ROWS
NUM_COLLECTION_PAGES EQU NUM_TREASURES / NUM_COLLECTION_CELLS
NUM_TREASURE_TILES     EQU 4
