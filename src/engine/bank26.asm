...
; loads in wLevelTreasureIDs the treasure IDs for level in w2d00f
...
; loads in de the treasure IDs for level in w2d00f from hl
GetLevelTreasures: ; 9ab8f (26:6b8f)
	ld a, [w2d00f]
	add a
	add a ; *4
	ld c, a
