...
.frame_0
	frame_oam   0,   0, $60, 1 | X_FLIP
	frame_oam   0,  -8, $60, 1
	db $80

.frame_1
	frame_oam   0,   0, $62, 1 | X_FLIP
	frame_oam   0,  -8, $62, 1
	db $80

.frame_2
	frame_oam   0,  -8, $64, 1
	frame_oam   0,   0, $64, 1 | X_FLIP
	db $80

.frame_3
	frame_oam   0,  -8, $66, 1
	frame_oam   0,   0, $66, 1 | X_FLIP
	db $80

.frame_4
	frame_oam   8,   0, $6c, 1 | X_FLIP
	frame_oam   8,  -8, $6c, 1
	db $80

.frame_5
	frame_oam   8,   0, $6a, 1 | X_FLIP
	frame_oam   8,  -8, $6a, 1
	db $80

.frame_6
	frame_oam   8,   0, $6e, 1 | X_FLIP
	frame_oam   8,  -8, $6e, 1
	db $80

.frame_7
	frame_oam   8,   0, $68, 1 | X_FLIP
	frame_oam   8,  -8, $68, 1
	db $80
...
.frame_0
	frame_oam -32,   0, $9e, 6 | TILE_BANK | X_FLIP
	frame_oam -33,  -9, $a0, 6 | TILE_BANK
	frame_oam -16,  -8, $9e, 6 | TILE_BANK | Y_FLIP
	frame_oam -15,   1, $a0, 6 | TILE_BANK | X_FLIP | Y_FLIP
	db $80

.frame_1
	frame_oam -32, -12, $a2, 6 | TILE_BANK
	frame_oam -32,  -4, $a4, 6 | TILE_BANK
	frame_oam -16, -12, $a2, 6 | TILE_BANK | Y_FLIP
	frame_oam -16,  -4, $a4, 6 | TILE_BANK | Y_FLIP
	frame_oam -32,   4, $a2, 6 | TILE_BANK | X_FLIP
	frame_oam -16,   4, $a2, 6 | TILE_BANK | X_FLIP | Y_FLIP
	db $80

.frame_2
	frame_oam -33, -18, $a6, 6 | TILE_BANK
	frame_oam -43,  -9, $a8, 6 | TILE_BANK
	frame_oam -15, -18, $a6, 6 | TILE_BANK | Y_FLIP
	frame_oam  -5,  -9, $a8, 6 | TILE_BANK | Y_FLIP
	frame_oam -33,  10, $a6, 6 | TILE_BANK | X_FLIP
	frame_oam -43,   1, $a8, 6 | TILE_BANK | X_FLIP
	frame_oam -15,  10, $a6, 6 | TILE_BANK | X_FLIP | Y_FLIP
	frame_oam  -5,   1, $a8, 6 | TILE_BANK | X_FLIP | Y_FLIP
	db $80

.frame_3
	frame_oam -36, -24, $aa, 6 | TILE_BANK
	frame_oam -48, -12, $ac, 6 | TILE_BANK
	frame_oam -12,  16, $aa, 6 | TILE_BANK | X_FLIP | Y_FLIP
	frame_oam   0,   4, $ac, 6 | TILE_BANK | X_FLIP | Y_FLIP
	frame_oam -36,  16, $aa, 6 | TILE_BANK | X_FLIP
	frame_oam -48,   4, $ac, 6 | TILE_BANK | X_FLIP
	frame_oam -12, -24, $aa, 6 | TILE_BANK | Y_FLIP
	frame_oam   0, -12, $ac, 6 | TILE_BANK | Y_FLIP
	db $80
; 0xd622
...
.frame_2
	...
	frame_oam -21, -32, $b2, 0 | Y_FLIP
	frame_oam -63,   4, $b2, 0 | X_FLIP
	frame_oam -55,  22, $b2, 0 | X_FLIP | Y_FLIP
	frame_oam -22,  26, $b2, 0 | X_FLIP
	db $80

.frame_3
	frame_oam -54,  -6, $b4, 0 | X_FLIP
	frame_oam -50,  12, $b2, 0 | X_FLIP
	frame_oam -35,  24, $b2, 0 | X_FLIP
	frame_oam -17,  21, $b2, 0 | X_FLIP
	frame_oam  -6, -15, $b2, 0 | X_FLIP
	frame_oam -20, -24, $b2, 0 | X_FLIP
	frame_oam -43, -20, $b2, 0 | X_FLIP
	frame_oam -11,   7, $b4, 0 | X_FLIP
	db $80

.frame_4
	frame_oam -49,  27, $b2, 0 | X_FLIP
	frame_oam -21,  24, $b2, 0 | X_FLIP | Y_FLIP
	frame_oam -63, -12, $b2, 0
	frame_oam -55, -30, $b2, 0 | Y_FLIP
	frame_oam -22, -34, $b2, 0
	db $80

.frame_5
	frame_oam -46, -40, $b2, 0 | X_FLIP
	frame_oam -17, -40, $b2, 0 | Y_FLIP
	frame_oam -18,  32, $b2, 0 | X_FLIP
	frame_oam -56,  16, $b2, 0
	frame_oam  -7,  18, $b2, 0 | X_FLIP
	frame_oam -23, -51, $b2, 0
	frame_oam -41,  28, $b2, 0 | X_FLIP
	db $80

.frame_6
	frame_oam -46,  32, $b2, 0
	frame_oam -17,  32, $b2, 0 | X_FLIP | Y_FLIP
	frame_oam -18, -40, $b2, 0
	frame_oam -56, -24, $b2, 0 | X_FLIP
	frame_oam  -7, -26, $b2, 0
	frame_oam -23,  43, $b2, 0 | X_FLIP
...
.frame_0
	frame_oam -54, -25, $b4, 2 | X_FLIP | Y_FLIP
	frame_oam -14, -23, $b2, 2 | Y_FLIP
	frame_oam -17, -41, $b2, 2 | X_FLIP | Y_FLIP
	frame_oam -16,  13, $b2, 2 | X_FLIP | Y_FLIP
	frame_oam -33,  29, $b2, 2
	frame_oam -60,   0, $b2, 2 | Y_FLIP
	frame_oam -65, -18, $b2, 2 | X_FLIP
	frame_oam -50, -40, $b2, 2
	db $80

.frame_1
	frame_oam -57, -29, $b2, 2
	frame_oam -10, -28, $b2, 2 | Y_FLIP
...
.frame_6
	frame_oam  -8,   0, $40, 1 | X_FLIP | Y_FLIP
	frame_oam -24,   8, $44, 1 | X_FLIP | Y_FLIP
	db $80

.frame_7
	frame_oam  -8,   0, $42, 1 | X_FLIP | Y_FLIP
	frame_oam -24,   8, $46, 1 | X_FLIP | Y_FLIP
	db $80

.frame_8
	frame_oam  -8,   0, $44, 1 | X_FLIP | Y_FLIP
	frame_oam -30, -16, $40, 1 | X_FLIP | Y_FLIP
	db $80

.frame_9
	frame_oam  -8,   0, $46, 1 | X_FLIP | Y_FLIP
	frame_oam -30, -16, $42, 1 | X_FLIP | Y_FLIP
	db $80

.frame_10
	frame_oam -30, -16, $44, 1 | X_FLIP | Y_FLIP
	frame_oam -24,   8, $40, 1 | X_FLIP | Y_FLIP
	db $80

.frame_11
	frame_oam -30, -16, $46, 1 | X_FLIP | Y_FLIP
	frame_oam -24,   8, $42, 1 | X_FLIP | Y_FLIP
	db $80

.frame_12
	frame_oam -24,  -8, $48, 1
	frame_oam -24,   0, $48, 1 | X_FLIP
	db $80

.frame_13
	frame_oam -24,   3, $4e, 1
	frame_oam -24, -11, $4e, 1 | X_FLIP
	db $80

.frame_14
	frame_oam -37,   8, $4a, 1 | X_FLIP | Y_FLIP
	frame_oam -37, -16, $4a, 1 | X_FLIP
	frame_oam -12,   8, $4a, 1 | Y_FLIP
	frame_oam -12, -16, $4a, 1
	db $80

.frame_15
	frame_oam -37, -16, $4a, 1 | Y_FLIP
	frame_oam -37,   8, $4a, 1
	frame_oam -12, -16, $4a, 1 | X_FLIP | Y_FLIP
	frame_oam -12,   8, $4a, 1 | X_FLIP
	db $80

.frame_16
	frame_oam  -5,  14, $4c, 1
	frame_oam  -5, -22, $4c, 1 | X_FLIP
	frame_oam -43,  14, $4c, 1 | Y_FLIP
	frame_oam -43, -22, $4c, 1 | X_FLIP | Y_FLIP
	db $80
