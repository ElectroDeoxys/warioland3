...
SECTION "Bank 40", ROMX
	...
	INCROM $100000, $104000


SECTION "Bank 41", ROMX

	INCROM $104000, $108000


SECTION "Bank 42", ROMX

	INCROM $108000, $10c000


SECTION "Bank 43", ROMX

	INCROM $10c000, $110000


SECTION "Bank 44", ROMX

	INCROM $110000, $114000


SECTION "Bank 45", ROMX

	INCROM $114000, $118000


SECTION "Bank 46", ROMX

	INCROM $118000, $11c000


SECTION "Bank 47", ROMX

	INCROM $11c000, $120000


SECTION "Bank 48", ROMX

	INCROM $120000, $124000


SECTION "Bank 49", ROMX

	INCROM $124000, $128000


SECTION "Bank 4A", ROMX

	INCROM $128000, $12c000


SECTION "Bank 4B", ROMX

	INCROM $12c000, $130000


SECTION "Bank 4C", ROMX

	INCROM $130000, $134000


SECTION "Bank 4D", ROMX

	INCROM $134000, $138000
...
SECTION "Bank 56", ROMX
	...
	INCROM $158000, $15c000


SECTION "Bank 57", ROMX

	INCROM $15c000, $160000
...
SECTION "Bank 59", ROMX
	...
	INCROM $164000, $168000


SECTION "Bank 60", ROMX

	INCROM $180000, $184000


SECTION "Bank 61", ROMX

	INCROM $184000, $188000


SECTION "Bank 62", ROMX

	INCROM $188000, $18c000


SECTION "Bank 63", ROMX

	INCROM $18c000, $190000


SECTION "Bank 64", ROMX

	INCROM $190000, $194000


SECTION "Bank 65", ROMX

	INCROM $194000, $198000
...
SECTION "Bank 70", ROMX
	...
	INCROM $1c0000, $1c4000


SECTION "Bank 71", ROMX

	INCROM $1c4000, $1c8000
...
SECTION "Bank 78", ROMX
	...
	INCROM $1e0000, $1e4000


SECTION "Bank 79", ROMX

	INCROM $1e4000, $1e8000


SECTION "Bank 7A", ROMX

	INCROM $1e8000, $1ec000
